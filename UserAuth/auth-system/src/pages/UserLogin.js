    ...
    return (
        <>            
            <form className={props.classes.root} >
                ...
                <Button onClick={handleSubmit} style={{ backgroundColor: 'white' }} variant="contained" size="small" className={props.classes.margin}>
                    <LockOpenIcon className={props.classes.icon} fontSize="small" /> Sign in
            </Button>
