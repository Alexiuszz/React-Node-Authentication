    ...
    return (
        <>
            <form className={props.classes.root} >
                <AssignmentIndIcon className={props.classes.icon} fontSize="large" />
                        ...
                        endAdornment={
                            <InputAdornment position="end" color="transparent">
                                <IconButton
                                    ...
                                    onClick={props.AccountCirclehandleClickShowPassword}
                ...
                <Button onClick={props.handleSubmit} style={{ width: '100px' }} variant="contained" size="small" className={props.classes.margin}>
